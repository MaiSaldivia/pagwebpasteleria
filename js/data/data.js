...
window.PRODUCTS = [
  {id:"TC001", nombre:"Torta Cuadrada de Chocolate", precio:45000, categoria:"Tortas Cuadradas", attr:"20 porciones", img:"img/Torta Cuadrada de Chocolate.png", stock:6, stockCritico:2},
  {id:"TC002", nombre:"Torta Cuadrada de Frutas", precio:50000, categoria:"Tortas Cuadradas", attr:"Frutas frescas", img:"img/Torta Cuadrada de Frutas.png", stock:6, stockCritico:2},
  {id:"TT001", nombre:"Torta Circular de Vainilla", precio:40000, categoria:"Tortas Circulares", attr:"12 porciones", img:"img/Torta Circular de Vainilla.png", stock:6, stockCritico:2},
  {id:"TT002", nombre:"Torta Circular de Manjar", precio:42000, categoria:"Tortas Circulares", attr:"Con nueces", img:"img/Torta Circular de Manjar.png", stock:6, stockCritico:2},
  {id:"PI001", nombre:"Mousse de Chocolate", precio:5000,  categoria:"Postres Individuales", attr:"Individual", img:"img/Mousse de Chocolate.png", stock:6, stockCritico:2},
  {id:"PI002", nombre:"Tiramisú Clásico", precio:5500, categoria:"Postres Individuales", attr:"Individual", img:"img/Tiramisú Clásico.png", stock:6, stockCritico:2},
  {id:"PSA001", nombre:"Torta Sin Azúcar de Naranja", precio:48000, categoria:"Productos Sin Azúcar", attr:"Endulzada naturalmente", img:"img/Torta Sin Azúcar de Naranja.png", stock:6, stockCritico:2},
  {id:"PSA002", nombre:"Cheesecake Sin Azúcar", precio:47000, categoria:"Productos Sin Azúcar", attr:"Sin azúcar", img:"img/Cheesecake.png", stock:6, stockCritico:2},
  {id:"PG001", nombre:"Brownie Sin Gluten", precio:4000, categoria:"Productos Sin Gluten", attr:"Cacao 70%", img:"img/Brownie.png", stock:6, stockCritico:2},
  {id:"PG002", nombre:"Pan Sin Gluten", precio:3500, categoria:"Productos Sin Gluten", attr:"Pan de molde", img:"img/Pan integral.png", stock:6, stockCritico:2},
  {id:"PV001", nombre:"Torta Vegana de Chocolate", precio:50000, categoria:"Productos Vegana", attr:"Vegano", img:"img/Torta Vegana de Chocolate.png", stock:6, stockCritico:2},
  {id:"PV002", nombre:"Galletas Veganas de Avena", precio:4500, categoria:"Productos Vegana", attr:"Pack x 10", img:"img/Galletas Veganas de Avena.png", stock:6, stockCritico:2},
  {id:"TE001", nombre:"Torta Especial de Cumpleaños", precio:55000, categoria:"Tortas Especiales", attr:"Personalizable", img:"img/Torta Especial de Cumpleaños.png", stock:6, stockCritico:2},
  {id:"TE002", nombre:"Torta Especial de Boda", precio:60000, categoria:"Tortas Especiales", attr:"Diseño elegante", img:"img/Torta Especial de Boda.png", stock:6, stockCritico:2},
];
